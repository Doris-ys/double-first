    ...
    // 数据填报
      {
        ...
        redirect: '/datafill/university',
        component: RouteView,
        meta: { title: '数据填报', keepAlive: true, icon: 'form' },
        children: [
          {
      ...
      // 数据管理
      {
        path: '/datamanage',
        name: 'datamanage',
        redirect: '/datamanage/university',
        component: RouteView,
        meta: { title: '数据管理', keepAlive: true, icon: 'copy' },
        children: [
          {
      ...
      // 消息中心
      {
        ...
        component: RouteView,
        meta: { title: '消息中心', keepAlive: true, icon: 'mail' },
        children: [
          {
            path: '/message/index',
            name: 'Message',
            component: () => import('@/views//message/index'),
            meta: { title: '返回消息', keepAlive: false }
          }
        ]
      },
      // 消息中心
      {
        path: '/usermanage',
        name: 'usermanage',
        redirect: '/usermanage/check',
        component: RouteView,
        meta: { title: '用户管理', keepAlive: true, icon: 'user' },
        children: [
          {
            path: '/usermanage/check',
            name: 'UserCheck',
            component: () => import('@/views//usermanage/check'),
            meta: { title: '查看用户', keepAlive: false }
          },
          {
            path: '/usermanage/add',
            name: 'UserAdd',
